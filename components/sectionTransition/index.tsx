        ...
        <ul className="flex justify-between flex-wrap text-center align-top">
          <li className=" p-4 flex flex-col justify-center items-center w-1/4">
            ...
            <p className="flex-grow">
              ...
              demostrando tecnologias e seus projetos, de pesquisar e desvendar
              os mais variados tipos de ferramentas e tecnologias.
            </p>
          </li>
          <li className=" p-4 flex flex-col justify-center items-center w-1/4">
          ...
          <li className=" p-4 flex flex-col justify-center items-center w-1/4">
            ...
            <p className="flex-grow">
              A todo momento procuro evoluir minhas habilidades e conhecimentos
              em programação fullstack, design, DevOps, UX/UI e qualquer
              tecnologia que contribua para o melhor produto final possível.
            </p>
          </li>
        </ul>
      </div>
